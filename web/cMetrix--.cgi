...
#Version=1.0
#
#perl /etc/EXT/Citation_Metrics/web/cMetrix.cgi get -v -M GET /
#
#perl /etc/EXT/Citation_Metrics/web/cMetrix.cgi get -v -M POST /eProofing?"Input_Type=XML&Key=IN4mJl11HTB3hvSdjTRGNS6gzychYyk9WvbSBCdfhkI&Input_File=/etc/EXT/Citation_Metrics/Input.105_2014_3530_Article.xml"
#
#curl -v -F Input_File=@/etc/EXT/Citation_Metrics/Input/test/66_2014_712_test.xml http://10.113.5.197:8080/cMetrix/cMetrix.cgi/eProofing?"Input_Type=XML&Key=IN4mJl11HTB3hvSdjTRGNS6gzychYyk9WvbSBCdfhkI"
#
#perl /etc/EXT/Citation_Metrics/web/cMetrix.cgi get -v -M POST /Status?"Token=3780e99a-fc2c-54e5-2c31-417f945c1792"
#
#http://10.113.5.197:8080/cMetrix/cMetrix.cgi
#http://10.113.5.197:8080/cMetrix.cgi
#============================================================================================================
